...
export default function QuickActions({ onNewTaskClick, onNewTeamClick }: any) {
  return (
    <div className="bg-white dark:bg-zinc-900 border-2 border-zinc-300 dark:border-zinc-800 rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-5 md:p-6 lg:p-8 h-fit shadow-xl shadow-zinc-200/50 dark:shadow-none relative overflow-hidden w-full">
      <div className="absolute top-0 right-0 w-24 h-24 bg-indigo-500/10 blur-3xl -z-10 rounded-full" />
      <h2 className="text-lg sm:text-xl font-black text-zinc-900 dark:text-white mb-6 sm:mb-8 flex items-center gap-2 sm:gap-3">
      ...
      <div className="space-y-4">
        ...
        <button 
          ...
          className="w-full group bg-white dark:bg-zinc-800 border-2 border-zinc-200 dark:border-zinc-700 hover:border-indigo-500 dark:hover:border-indigo-500 p-4 rounded-2xl flex items-center justify-between transition-all duration-300 shadow-sm active:scale-95 hover:scale-[1.02]"
        >
          <div className="flex items-center gap-3">
